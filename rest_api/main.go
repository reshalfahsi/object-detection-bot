...
import (
	...
	. "github.com/reshalfahsi/backend_project_template/rest_api/config" // construct read to read db config with toml
	. "github.com/reshalfahsi/backend_project_template/rest_api/dao"    // data access object
	. "github.com/reshalfahsi/backend_project_template/rest_api/models" // to import all model (include User)
